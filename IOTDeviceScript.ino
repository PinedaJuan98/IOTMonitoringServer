...
const char pass[] = "passWIFI"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "44.198.51.35"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
